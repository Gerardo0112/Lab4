...
namespace Lab4_Estructuras.Models
{
    public class Nodo
    {
        ...
        public void Fuse(Nodo n1)
        {
            ...
            if (totalKeys > 3)
            {
                throw new InvalidOperationException("El total de las llaves se excede de 3");
            }


            if (totalEdges > 4)
            {
                throw new InvalidOperationException("El total de los nodos se excede de 4");
            }
        ...
        public void Fuse(Nodo n1, Nodo n2)
        {
            ...
            if (totalEdges > 4)
            {
                throw new InvalidOperationException("El total de las llaves se excede de 4");
            }
        ...
        public Nodo[] Split()
        {
            if (Keys.Count != 2)
            {
                throw new InvalidOperationException(string.Format("Este nodo tiene {0} llaves, Solo se puede dividir un nodo de 2 teclas", Keys.Count));
            }
        ...
        public int? Pop(int position)
        {
            if (Keys.Count == 1)
            {
                throw new InvalidOperationException("No se puede extraer el valor de un nodo clave 1");
            }
        ...
        public void Push(int k)
        {
            if (Keys.Count == 3)
            {
                throw new InvalidOperationException("No se puede insertar valor en un nodo de 3 claves");
            }
